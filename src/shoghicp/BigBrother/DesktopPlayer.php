...
use xSuper\Practice\cosmetics\packs\Pack;
...
class DesktopPlayer extends Player{
	...
	public function handleMobEquipment(MobEquipmentPacket $packet): bool
	{
		...
		if ($packet->item instanceof ItemStackWrapper) $nItem = $packet->item->getItemStack();
		else $nItem = $packet->item;
